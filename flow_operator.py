...
def deriv_quadra_over_x(x,sigma):
    ...
    return y
########################################################
def flow_operator(u,v, du,dv, It, Ix, Iy,S,lmbda,eps,a):
    ...
    for i in range(len(S)):
        ...
        '''pp_su=deriv_charbonnier_over_x(u_,eps,a)
        pp_sv=deriv_charbonnier_over_x(v_,eps,a)'''
    ...
    #pp_d=deriv_charbonnier_over_x(np.reshape(It,(npixels,1),'F'),eps,a)
...
#############################################################
def flow_operator_quadr(u,v, du,dv, It, Ix, Iy,S,lmbda,sigma_qua):
    ...
    return [A,b,iterative]
#############################################################
def  compute_flow_base(Image1,Image2,max_iter,max_linear_iter,u,v,alpha,lmbda,S,size_median_filter,h,coef,uhat,vhat,itersLO,lambda2,lambda3,remplacement,eps,a,sigma_qua):
    ...
    for i in range(max_iter):
        ...
        for j in range(max_linear_iter):
            if (alpha==1):
                [A,b,iterative]=flow_operator_quadr(u,v, du,dv, It, Ix, Iy,S,lmbda,sigma_qua)
            elif(alpha>0 and alpha != 1):
                [A,b,iterative]=flow_operator_quadr(u,v, du,dv, It, Ix, Iy,S,lmbda,sigma_qua)

                [A1,b1,iterative1]=flow_operator(u,v, du,dv, It, Ix, Iy,S,lmbda,eps,a)
                
                A=alpha*A+(1-alpha)*A1
                b=alpha*b+(1-alpha)*b1
            elif(alpha==0):
                [A,b,iterative]=flow_operator(u,v, du,dv, It, Ix, Iy,S,lmbda,eps,a)
            '''print('A')
            print(A)'''
